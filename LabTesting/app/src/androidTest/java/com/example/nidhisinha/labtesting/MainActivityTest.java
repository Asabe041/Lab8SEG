package com.example.nidhisinha.labtesting;
...
public class MainActivityTest {
    ...
    @Rule
    public ActivityTestRule<MainActivity> m = new ActivityTestRule<MainActivity>(MainActivity.class);
    private MainActivity mActivity = null;
    private TextView text;

    @Before
    public void setUp() throws Exception{
        mActivity = m.getActivity();
    }
